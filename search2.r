REBOL [
    ...
    Author: "Kevin Adams"
    Needs: "REBOL View"
    Purpose: {Searches various places,such as Google, without having to go to their website .}
    Email: kadams@netlane.com
    Notes: {A little source code take from Jos Yule's Dictionary Lookup program.}
    library: [
        level: none 
        platform: none 
        type: none 
