...
^-^-(this is probably working only for icons in 24bits color depth!)}
    History: [
    14-Aug-2001 "oldes" {Fixed bug in the transparency of small (16x16) and large (64x64) icons} 
    8-Aug-2001 "oldes" {Improved - now should support even 4 and 8 bit color depth icons} 
    30-Jul-2001 "oldes" "initial version"
]
